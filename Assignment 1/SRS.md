...
-   [4. Implementation](#4-Implementation)
    -  [4.1 Methodology](#4-Methodology)
        ...
        -  [4.1.3 Feasible Methodologies](#4-Feasible-Methodologies)
            - [4.1.3.1 Data Collection](#41-Data-Collection)
            - [4.1.3.2 Data Preprocessing](#42-Data-Preprocessing)
            - [4.1.3.3 Feature Engineering](#43-Feature-Engineering)
            - [4.1.3.4 Training](#44-Training)
            - [4.1.3.5 Evaluation](#45-Evaluation)
            - [4.1.3.6 Hyperparameter Tuning](#46-Hyperparameter-Tuning)
            - [4.1.3.7 Model Deployment](#47-Model-Deployment)
...
-  [5. Standards Adopte](#5-Standards-Adopte)
    -  [5.1 Design Standards](#51-Design-Standards)
    -  [5.2 Coding Standards](#52-Coding-Standards)
